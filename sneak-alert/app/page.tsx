...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#101217] text-white overflow-x-hidden selection:bg-[#60a5fa]/30">
      
      {/* 🚀 Hero Section */}
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#1e3a8a]/20 rounded-full blur-[120px] -z-10" />
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-[0.9] mb-8">
            Wired for <span className="text-[#818cf8] italic">Winners</span>. <br />
            Scraped for <span className="bg-gradient-to-r from-cyan-400 via-white to-blue-500 bg-clip-text text-transparent">Seekers.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/seek" className="group h-14 px-10 bg-[#818cf8] text-[#101217] rounded-full flex items-center justify-center font-black uppercase text-sm hover:bg-white transition-all shadow-[0_0_40px_rgba(129,140,248,0.4)] hover:shadow-[0_0_60px_rgba(255,255,255,0.4)] active:scale-95">
              Enter The Terminal
        ...
        <motion.div 
          ...
          className="absolute bottom-0 w-full max-w-5xl h-64 bg-gradient-to-t from-[#101217] via-[#101217]/50 to-transparent z-10"
        />
      </section>
      ...
      <section className="py-32 px-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 30 }} viewport={{ once: true }}>
            <div className="w-14 h-14 rounded-2xl bg-[#083344] flex items-center justify-center text-cyan-400 mb-8 shadow-[0_0_25px_rgba(34,211,238,0.2)] border border-cyan-400/30">
          ...
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 30 }} transition={{ delay: 0.1 }} viewport={{ once: true }}>
            <div className="w-14 h-14 rounded-2xl bg-[#1e1b4b] flex items-center justify-center text-[#818cf8] mb-8 shadow-[0_0_25px_rgba(129,140,248,0.2)] border border-[#818cf8]/30">
              <Activity className="w-7 h-7" />
            </div>
            <h3 className="text-2xl font-black uppercase tracking-tighter mb-4 text-[#818cf8]">Zero-Lapse Velocity</h3>
            <p className="text-gray-400 leading-relaxed font-medium">
          ...
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 30 }} transition={{ delay: 0.2 }} viewport={{ once: true }}>
            <div className="w-14 h-14 rounded-2xl bg-[#431407] flex items-center justify-center text-[#fb923c] mb-8 shadow-[0_0_25px_rgba(251,146,60,0.2)] border border-[#fb923c]/30">
      ...
      {/* 👟 About Section */}
      <section className="py-32 bg-white/x[0.02] border-t border-white/5 px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="h-[400px] bg-gradient-to-br from-[#1e1b4b] to-[#101217] rounded-3xl border border-white/10 relative shadow-2xl overflow-hidden"
          >
      ...
      {/* 💎 Pricing Section */}
      <section className="py-32 px-8 bg-[#101217]">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <span className="text-[#818cf8] font-black uppercase tracking-widest text-xs mb-4 block">Memberships</span>
          <h2 className="text-5xl font-black uppercase tracking-tighter mb-6">Choose Your <span className="text-[#818cf8]">Tier</span></h2>
        </div>
        
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div whileHover={{ y: -10 }} className="p-10 rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden group">
            ...
            <ul className="space-y-4 mb-10 text-left">
              ...
              <li className="flex items-center gap-3 text-sm text-gray-400 group-hover:text-white transition-colors duration-300"><Zap className="w-4 h-4 text-cyan-400" /> Top 4 Retailers</li>
          ...
          <motion.div whileHover={{ y: -10 }} className="p-10 rounded-3xl bg-gradient-to-br from-[#1e1b4b] to-[#101217] border border-[#818cf8]/40 relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-4 bg-[#818cf8] text-[#101217] rounded-bl-2xl font-black uppercase text-[10px] tracking-widest">Recommended</div>
            ...
            <ul className="space-y-4 mb-10 text-left">
              ...
              <li className="flex items-center gap-3 text-sm text-gray-400 group-hover:text-white transition-colors duration-300">
                ...
                <span>Global Node Access (Amazon US/UK)</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-400 group-hover:text-white transition-colors duration-300">
            ...
            <button disabled className="w-full h-14 bg-[#818cf8] text-[#101217] rounded-2xl flex items-center justify-center font-black uppercase text-xs transition-all shadow-[0_0_20px_rgba(129,140,248,0.3)] opacity-50 cursor-not-allowed italic">Coming_Soon</button>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 px-12 border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto flex flex-col gap-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
             <div className="order-2 md:order-1 text-left">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">
                   Stop tab-switching. SoleNode aggregates live inventory from Shelflife, Jack Lemkus, Archive, and Amazon into a single, high-frequency stream. Map colors, sizes, and price drops across the entire market in one unified interface.
                </p>
             </div>
             <div className="order-1 md:order-2 aspect-video bg-white/5 border border-white/10 rounded-3xl relative overflow-hidden group shadow-2xl">
                <div className="absolute inset-x-6 inset-y-6 bg-[#101217] rounded-2xl border border-white/5 p-8 flex flex-col gap-4">
                   <div className="flex justify-between items-center mb-4">
                      <div className="h-4 w-1/3 bg-[#083344] rounded" />
                      <div className="h-4 w-12 bg-[#00C853]/20 rounded" />
                   </div>
                   <div className="space-y-4">
                      <div className="h-2 w-full bg-white/5 rounded" />
                      <div className="h-2 w-4/5 bg-white/5 rounded" />
                      <div className="h-2 w-full bg-white/5 rounded-full bg-gradient-to-r from-cyan-400/20 to-transparent" />
                   </div>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-[#101217] via-transparent to-transparent opacity-60" />
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
             <div className="aspect-video bg-white/5 border border-white/10 rounded-3xl relative overflow-hidden flex items-center justify-center shadow-2xl">
                <div className="relative">
                   <Bell className="w-20 h-20 text-[#818cf8]/20 animate-pulse" />
                   <div className="absolute -top-1 -right-1 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center text-[10px] font-bold shadow-[0_0_15px_rgba(239,68,68,0.5)]">!</div>
                </div>
             </div>
             <div className="text-left">
                ...
                <h2 className="text-4xl font-black uppercase tracking-tighter mb-6 underline decoration-[#818cf8]/30 underline-offset-8">5-Channel Blast System</h2>
                <p className="text-gray-400 text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
             <div className="order-2 md:order-1 text-left">
                <div className="flex items-center gap-3 mb-6 justify-start">
                   <Search className="w-5 h-5 text-[#fb923c]" />
                   <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">Arbitrage Intelligence</span>
                </div>
                <h2 className="text-4xl font-black uppercase tracking-tighter mb-6 underline decoration-[#fb923c]/30 underline-offset-8">Cross-Retailer Price Tracking</h2>
                <p className="text-gray-400 text-lg leading-relaxed">
                   Identify market inefficiencies in real-time. Compare Amazon listings with boutique retail prices to find the highest margin pairs. Our price-drop detection highlights "Steals" the moment a retailer marks down their stock.
                </p>
             </div>
      ...
      <section className="py-32 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end mb-16 gap-8 text-left md:text-left">
          <div>
            ...
            <h2 className="text-5xl font-black uppercase tracking-tighter text-white">The <span className="text-ds-indigo/80">Insights</span></h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <motion.div key={i} whileHover={{ y: -10 }} className="group cursor-pointer">
               ...
               <span className="text-[10px] text-ds-indigo/60 font-black uppercase tracking-widest mb-3 block">Tech | March 25, 2026</span>
               <h3 className="text-xl font-black uppercase mb-4 group-hover:text-ds-indigo/80 transition-colors leading-snug">
                 {i === 1 ? "Decoding Vtex Catalog API Scrapers" : i === 2 ? "How Amazon is Fighting Botters in 2026" : "Jordan 4 Restock: Best Scraper Strategies"}
               </h3>
               <p className="text-gray-500 text-sm leading-relaxed line-clamp-2">
                 Exploring the latest architectural shifts in retail APIs and how SoleNode stays one step ahead with our stealth delivery network.
               </p>
            </motion.div>
          ))}
        </div>
